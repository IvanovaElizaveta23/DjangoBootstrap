...
class List_test(models.Model):
    cover = models.ImageField(upload_to='images/',blank=True,verbose_name="Абложка теста")
    ...
    count_treing= models.IntegerField(verbose_name="Кол-во попыток в тесте")
...
class Result(models.Model):
    answers = models.TextField(max_length=5000000,verbose_name="Ответы на тест")
